...
const ScrollProgressIndicator = () => {
  ...
  return (
    <>
      ...
      <motion.div
        className="hidden md:block fixed right-6 bottom-[35vh] z-[60] space-y-4"
          ...
          return (
            ...
            >
              ...
              {index < sections.length - 1 && (
                <motion.div
                  className={`absolute -bottom-4 left-1/2 transform -translate-x-1/2 w-0.5 h-4 transition-all duration-300 ${isPassed ? 'bg-primary/40' : 'bg-muted-foreground/20'
                    }`}
                  animate={{
